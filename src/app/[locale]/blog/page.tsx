          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="animate-pulse">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[...Array(3)].map((_, i) => (
                  <Card key={i} className="p-6 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700">
      ...
      <div className="py-20 bg-gradient-to-br from-gray-50 to-white dark:from-slate-900 dark:to-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {filteredPosts.map((post, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="p-6 hover:shadow-md transition-shadow bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700">
                      ...
                      <div className="flex space-x-2 mt-3">
                        {post.tags.slice(0, 3).map((tag) => (
                          <button
                            key={tag}
                            onClick={() => handleTagFilter(tag)}
                            className="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs hover:bg-blue-200 transition-colors dark:bg-blue-900/30 dark:text-blue-300"
                          >
                            {tag}
                          </button>
                        ))}
          ...
          {posts.length > 0 && (
            ...
            >
              <Card className="max-w-2xl mx-auto bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700">
