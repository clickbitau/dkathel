      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-6xl sm:text-7xl lg:text-8xl font-bold text-primary dark:text-white mb-6">
            <span className={`text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 ${isBengali ? 'font-heading-bn' : 'font-heading-en'}`}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-8">
          {partnerLogos.map((partner, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-110 border border-gray-200 dark:border-slate-700">
