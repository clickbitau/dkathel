    ...
    <>
      <div className="group perspective-1000">
        ...
        >
          ...
          <div className="absolute inset-0 w-full h-full backface-hidden">
            <Card className="h-full hover:shadow-2xl transition-all duration-500 overflow-hidden border-0 bg-gradient-to-br from-white to-slate-50 dark:from-gray-800 dark:to-gray-900">
              ...
              <CardContent className="flex-1 flex items-center justify-center p-6 bg-gradient-to-br from-gray-50 to-white dark:from-slate-700 dark:to-gray-800">
                <div className="relative w-full h-80 bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-lg border border-slate-200 dark:border-gray-600">
                  <Image
              ...
              <div className="p-4 pt-0 text-center bg-gradient-to-r from-blue-600/10 to-purple-600/10 dark:from-blue-600/20 dark:to-purple-600/20">
                ...
                <div className="h-1 w-20 bg-gradient-to-r from-gray-600 to-teal-500 rounded-full mx-auto"></div>
              </div>
            </Card>
          </div>
          ...
          <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180">
            <Card className="h-full bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-800 dark:via-slate-700 dark:to-gray-900 hover:shadow-2xl transition-all duration-500 border-0">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {certification.skills.slice(0, 4).map((skill) => (
                        <Badge key={skill} className="bg-gradient-to-r from-gray-600 to-teal-500 text-white text-xs font-medium border-0">
                          {skill}
                        </Badge>
                      ))}
                      {certification.skills.length > 4 && (
                        <Badge className="bg-gradient-to-r from-gray-500 to-slate-600 text-white text-xs font-medium border-0">
                ...
                <div className="pt-2 space-y-2">
                  {certification.pdfUrl && (
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full bg-gradient-to-r from-gray-600 to-teal-500 text-white border-0 hover:from-blue-600 hover:to-purple-600"
                      onClick={(e) => {
                        e.stopPropagation();
                  ...
                  {certification.credentialUrl && (
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full border-slate-300 dark:border-gray-600 hover:bg-slate-100 dark:hover:bg-slate-700"
                      onClick={(e) => {
                        e.stopPropagation();
      ...
      {showLargeImage && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="relative max-w-5xl max-h-[95vh] bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-2xl border border-slate-200 dark:border-gray-700">
            <div className="absolute top-4 right-4 z-10">
              <Button
                variant="ghost"
                size="sm"
                className="h-10 w-10 p-0 bg-white/90 dark:bg-gray-800 hover:bg-white dark:hover:bg-slate-700 border border-slate-200 dark:border-gray-600"
            ...
            <div className="p-6 bg-gradient-to-r from-gray-700 to-gray-900 text-white">
              ...
              <p className="text-gray-300 text-sm mt-1">{certification.category}</p>
            </div>
            <div className="relative w-full h-full p-6 bg-slate-50 dark:bg-gray-800">
              <div className="relative w-full h-[70vh] bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-lg border border-slate-200 dark:border-gray-600">
                <Image
                  src={encodeURI(certification.image)}
                  alt={certification.name}
                  fill
            ...
            {certification.pdfUrl && (
              <div className="p-6 bg-slate-100 dark:bg-gray-800 border-t border-slate-200 dark:border-gray-700">
                <Button
                  className="w-full bg-gradient-to-r from-gray-600 to-teal-500 text-white hover:from-blue-600 hover:to-purple-600"
                  onClick={(e) => {
                    e.stopPropagation();
