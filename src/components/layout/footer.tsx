        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href={`/${locale}/experience`} className="text-slate-600 hover:text-blue-600 dark:text-slate-300 dark:hover:text-white transition-colors">
                  {t('experience')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/certifications`} className="text-slate-600 hover:text-blue-600 dark:text-slate-300 dark:hover:text-white transition-colors">
                  {t('certifications')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/blog`} className="text-slate-600 hover:text-blue-600 dark:text-slate-300 dark:hover:text-white transition-colors">
                  {t('blog')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/contact`} className="text-slate-600 hover:text-blue-600 dark:text-slate-300 dark:hover:text-white transition-colors">
                  {t('contact')}
                </Link>
              </li>
            </ul>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <a
                  ...
                  className="text-slate-600 hover:text-blue-600 dark:text-slate-300 dark:hover:text-white transition-colors"
                >
                  GitHub
                </a>
              </li>
