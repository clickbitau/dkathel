...
const AchievementCard = ({ achievement, index, locale }: { achievement: AchievementCategory, index: number, locale: string }) => (
  ...
  >
    <div className="absolute -inset-1 bg-gradient-to-r from-gray-600 to-teal-500 rounded-3xl opacity-0 group-hover:opacity-20 blur transition duration-500"></div>
    <div className="relative h-full bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-blue-800">
      ...
      <div className="space-y-5">
        {achievement.items.map((item, i) => (
          <motion.div
            ...
            className="flex items-start p-5 bg-gradient-to-r from-gray-50 to-gray-50 dark:from-slate-700/50 dark:to-slate-600/50 rounded-xl group-hover:bg-gradient-to-r group-hover:from-blue-50 group-hover:to-purple-50 dark:group-hover:from-slate-700 dark:group-hover:to-slate-800 transition-all duration-300 border border-gray-100 dark:border-gray-600 hover:border-gray-200 dark:hover:border-blue-700"
          >
            <div className={`w-20 text-2xl font-bold bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent flex-shrink-0 mr-4 ${locale === 'bn' ? 'font-body-bn' : 'font-body-en'}`}>
...
export function Achievements({ translations }: AchievementsProps) {
  ...
  return (
    <section className="py-24 px-4 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-slate-800 dark:to-gray-900 relative overflow-hidden">
