      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className={`text-6xl sm:text-7xl lg:text-8xl font-bold text-gray-900 dark:text-white mb-6 ${locale === 'bn' ? 'font-heading-bn' : 'font-heading-en'}`}>
            Brand <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-900 dark:from-blue-400 dark:to-purple-400">Collaborations</span>
          </h2>
          ...
          {brands.map((brand, index) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <Card className="h-full p-8 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 cursor-pointer bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
